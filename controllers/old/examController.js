        ...
        connection.query(examQuery, [tsc[0].TSC_ID,  req.body.exam_name,  req.body.exam_description, req.body.exam_date], async (err, exam, fields) => {
           if (err) {
              ...
              } else 
              {
                ...
                const StudentList = await commonModel.getStudentsList(academic[0].AY_ID,tsc[0].TSC_ID,'Exams');
                  ...
                  for(r = 0 ; r < Receivers.length ; r++ ){
                      ...
                      Receivers[r].map(async (Receiver)=>{
                          ...
                          if(Receiver.User_Role == "Student"){
                            //add Notifications
                            await commonModel.addNotifications(Receiver.User_ID,Receiver.User_Role,exam.insertId,5);
                            //send Notification
                            ...
                            notificationBody += ' '+arrLang["fr"]["Nouveau"]+' '+arrLang["fr"]["Notification_Exam"];
                            ...
                            await commonModel.sendPushNotification(Receiver.User_Expo_Token,name,notificationBody);
                              ...
                              //add Notifications
                              await commonModel.addNotifications(Receiver.User_ID,Receiver.User_Role,exam.insertId,5,Receiver.Parent_Child_ID);
                              //send Notification
                              const childName = Receiver.Child_Full_Name ;
                              const notificationBody = arrLang["fr"]["Nouveau"]+' '+arrLang["fr"]["Notification_Exam"]+' '+arrLang["fr"]["A_Ete_Ajoute"];
