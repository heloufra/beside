...
function matchCellWidths(els) {
	...
	console.log("matchCellWidths")
	console.log(maxInnerWidth);
	console.log("matchCellWidths")
...
var TimeGrid = Grid.extend({
	...
	slatRowHtml: function() {
		...
		while (slotTime < this.maxTime) {
			...
			// console.log("asdasdasdasdaskdhjkasgdjkhakshdajslkdjaksjdlkjald")
			// console.log(htmlEscape(slotDate.format(this.labelFormat)));
			// console.log(this.labelFormat);

			// console.log("asdasdasdasdaskdhjkasgdjkhakshdajslkdjaksjdlkjald")
			let style="";
			let title="";
			if(pauses.includes(htmlEscape(slotDate.format(this.labelFormat)))){
			...
			axisHtml =
				'<td data-title="'+htmlEscape(slotDate.format(this.labelFormat))+'" class="fc-axis fc-time ' + view.widgetContentClass + '" ' + view.axisStyleAttr() + '>' +
					(isLabeled ?
			...
			html +=
				'<tr ' + (isLabeled ? '' : 'class="fc-minor"') + ' '+style+'>' +
					(!isRTL ? axisHtml : '') +
