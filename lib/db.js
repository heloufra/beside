...
var academicyear = `create table if  not exists academicyear(
                          ...
                          AY_YearStart  varchar(255) default null, 
                          AY_YearEnd  varchar(255) default null, 
                          Institution_ID int not null);`;
...
var expenses = `create table if  not exists expenses(
                       ...
                       Expense_Color varchar(10) default null, 
...
var studentsubscribtion = `create table if  not exists studentsubscribtion(
                     ...
                     AY_ID int not null)
                     Subscription_AddedDate datetime default CURRENT_TIMESTAMP ;`
...
var attitude = `create table if  not exists attitude(
                     ...
                     Attitude_Note  text default null, 
...
var internal_expences = `CREATE TABLE IF NOT EXISTS internal_expences (
  Expence_ID int(11) primary key auto_increment,  
  Expence_Name  varchar(255) default null, 
  Expence_Image  varchar(255) default null, 
  Expence_Type  varchar(255) default null, 
  Expence_Periode  varchar(255) default null, 
  Expence_For  varchar(255) default null, 
  Expence_Status tinyint(1) NOT NULL DEFAULT '1',
  Expence_Addeddate datetime default CURRENT_TIMESTAMP,
  Institution_ID int(11) NOT NULL,
  AY_ID int(11) NOT NULL);`


connection.query(internal_expences, function(err, results, fields) {
    if (err) {
      console.log(err.message);
    }
});
...
var employees_expences_cost = `CREATE TABLE IF NOT EXISTS employees_expences_cost (
  EEC_ID int(11) primary key auto_increment,  
  EEC_Cost  varchar(255) default null, 
  EEC_Status tinyint(1) NOT NULL DEFAULT '1',
  EEC_Addeddate datetime default CURRENT_TIMESTAMP,
  Expence_ID int(11) NOT NULL,
  Employe_ID int(11) NOT NULL);`


connection.query(employees_expences_cost, function(err, results, fields) {
    if (err) {
      console.log(err.message);
    }
});
...
var institution_expences_cost = `CREATE TABLE IF NOT EXISTS institution_expences_cost (
  IEC_ID int(11) primary key auto_increment,  
  IEC_Cost  varchar(255) default null, 
  IEC_Status tinyint(1) NOT NULL DEFAULT '1',
  IEC_Addeddate datetime default CURRENT_TIMESTAMP,
  Expence_ID int(11) NOT NULL,
  Employe_ID int(11) NOT NULL);`


connection.query(institution_expences_cost, function(err, results, fields) {
    if (err) {
      console.log(err.message);
    }
});
...
var paid_expences = `CREATE TABLE IF NOT EXISTS paid_expences (
  PE_ID int(11) primary key auto_increment,  
  PE_Ammount  varchar(255) default null, 
  PE_Status tinyint(1) NOT NULL DEFAULT '1',
  PE_Addeddate datetime default CURRENT_TIMESTAMP,
  Expence_ID int(11) NOT NULL
);`


connection.query(paid_expences, function(err, results, fields) {
    if (err) {
      console.log(err.message);
    }
});
